...
function(CreateGLTFInstallTargets target platform)
    ...
    install(TARGETS ${target}
        ARCHIVE DESTINATION ${CMAKE_INSTALL_PREFIX}/$<CONFIG>
        LIBRARY DESTINATION ${CMAKE_INSTALL_PREFIX}/$<CONFIG>
        RUNTIME DESTINATION ${CMAKE_INSTALL_PREFIX}/$<CONFIG>
        BUNDLE DESTINATION ${CMAKE_INSTALL_PREFIX}/$<CONFIG>
    )

    if (MSVC)
        install(FILES ${CMAKE_CURRENT_BINARY_DIR}/$<CONFIG>/${PROJECT_NAME}.pdb DESTINATION ${CMAKE_INSTALL_PREFIX}/$<CONFIG>)
    endif()
